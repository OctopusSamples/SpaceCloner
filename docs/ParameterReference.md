...
- `ChildProjectsToSync` - The list of projects to sync the deployment process with.   Uses Regular expression matching.  If you supply the word "all" it will clone all lifecycles.  Examples: "AWS*,Default" or "all" or "AWS*".  Default value is `null` indicating nothing will be synced.
